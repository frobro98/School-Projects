                       ...
                       const _GLFWfbconfig* fbconfig)
{
	...
	//This is what we changed to make the wait for vertical sync work
	//Phil you commentless asshole made us look all over the place
	//next time Will will get you for this
	//!!!!
	window->wgl.SwapIntervalEXT(1);
