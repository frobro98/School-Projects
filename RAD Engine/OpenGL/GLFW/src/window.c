...
GLFWAPI void glfwWindowHint(int target, int hint)
{
    ...
    switch (target)
    {
        ...
        case GLFW_REFRESH_RATE:
            _glfw.hints.refreshRate = (GLboolean)hint;
            break;
        case GLFW_RESIZABLE:
...
{
	GLFWwindowclosefun t;
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
    //_GLFW_SWAP_POINTERS(window->callbacks.close, cbfun);

	t = window->callbacks.close;
...
{
	GLFWwindowrefreshfun t;
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
    //_GLFW_SWAP_POINTERS(window->callbacks.refresh, cbfun);

	t = window->callbacks.refresh;
...
{
	GLFWwindowfocusfun t;
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
    //_GLFW_SWAP_POINTERS(window->callbacks.focus, cbfun);

	t = window->callbacks.focus;
...
{
	GLFWwindowiconifyfun t;
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
    //_GLFW_SWAP_POINTERS(window->callbacks.iconify, cbfun);

	t = window->callbacks.iconify;
...
{
	GLFWframebuffersizefun t;
    _GLFWwindow* window = (_GLFWwindow*) handle;
    _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
    //_GLFW_SWAP_POINTERS(window->callbacks.fbsize, cbfun);

	t = window->callbacks.fbsize;
